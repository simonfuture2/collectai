  ...
  return (
    <LegalPageLayout title="Terms of Service" lastUpdated="February 25, 2026">
      ...
      <section>
        ...
        <p className="text-muted-foreground">
          All card identifications, condition grades, and valuations provided by CollectAI are AI-generated estimates only. They are <strong>not</strong> professional appraisals, certified grades, or guaranteed market values. CollectAI is not responsible for any financial decisions made based on our AI-generated estimates. For professional card grading, please consult certified grading services such as PSA, BGS, CGC, or SGC.
        </p>
      </section>

      <section>
        <h2 className="text-xl font-display font-bold">5. Credits and Subscriptions</h2>
        <p className="text-muted-foreground">
      ...
      <section>
        <h2 className="text-xl font-display font-bold">6. Payments and Billing</h2>
        <p className="text-muted-foreground">
      ...
      <section>
        <h2 className="text-xl font-display font-bold">7. Acceptable Use</h2>
        <p className="text-muted-foreground">
      ...
      <section>
        <h2 className="text-xl font-display font-bold">8. Intellectual Property</h2>
        <p className="text-muted-foreground">
      ...
      <section>
        <h2 className="text-xl font-display font-bold">9. Limitation of Liability</h2>
        <p className="text-muted-foreground">
      ...
      <section>
        <h2 className="text-xl font-display font-bold">10. Termination</h2>
        <p className="text-muted-foreground">
      ...
      <section>
        <h2 className="text-xl font-display font-bold">11. Changes to Terms</h2>
        <p className="text-muted-foreground">
      ...
      <section>
        <h2 className="text-xl font-display font-bold">12. Contact</h2>
        <p className="text-muted-foreground">
